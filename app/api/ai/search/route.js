...
3. Jab user kisi specific document/photo search kare ya us ke bare mein pooche, to us document ki details is format mein print karein (Urdu/Hindi short conversational sentence ke baad):
   Title: [file ka Title]
   Tags: [file ke tags]
   Description: [file ki description ya summary]
